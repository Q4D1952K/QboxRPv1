...
Config.Stores = {
    Supermarket = {
        ...
        items = {
            ['burger']         = { name = 'burger', price = 2, amount = 50, info = {}, type = 'item' },
            ['water']  = { name = 'water', price = 2, amount = 50, info = {}, type = 'item' },
            ['cola']     = { name = 'cola', price = 2, amount = 50, info = {}, type = 'item' },
        },
    },
    LTD = {
        blips = {
    ...
    Liquor = {
        ...
        items = {
            ['water'] = { name = 'water', price = 7, amount = 50, info = {}, type = 'item' },
            ['cola'] = { name = 'cola', price = 10, amount = 50, info = {}, type = 'item' },
            ['burger'] = { name = 'burger', price = 12, amount = 50, info = {}, type = 'item' },
        },
    },
    Hardware = {
        blips = {
    ...
    Ammunation = {
        ...
        items = {
            ...
            ['ammo-9'] = { name = 'ammo-9', price = 5, amount = 9999, info = {}, type = 'weapon', license = 'weapon' },
        },
    },
}
